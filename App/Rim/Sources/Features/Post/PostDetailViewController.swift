...
#Preview("for block") {
    ...
    let store = Store(initialState: stackState) {
        ...
        let dto = PostDetailDTO(id: "", title: "", content: "", imageUrl: "", markerUrl: "", location: .init(latitude: 0, longitude: 0), creatorID: "", isMine: false, createdAt: .init(seconds: 0, nanoseconds: 0))
