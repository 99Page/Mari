    ...
    @Test func removesPostFromMap_whenDeletedInDetailView() async throws {
        ...
        let store = TestStore(initialState: mapStack) {
            ...
            $0.postClient.fetchPostByID = { _ in
                let dto = PostDetailDTO(id: "post1", title: "title", content: "content", imageUrl: "", markerUrl: "", location: .init(latitude: 0, longitude: 0), creatorID: "creatorID", isMine: true, createdAt: .init(seconds: 0, nanoseconds: 0))
